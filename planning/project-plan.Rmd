...
Specifically, because of the following factors:
  1. **Diversity of cohorts** 
    potential biomarkers are evaluated in different samples / study cohorts 
  ...
  2. **Diversity of disease:** 
    potential biomarkers are evaluated in different disease sites / states
    - different sites of cancer
    - different state of disease
  3. **Diversity of therapies** 
    potential biomarkers are evaluated studies with different treatment or therapies 
